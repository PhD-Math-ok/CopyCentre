...
class CategoryFeature(models.Model):
    ...
    category = models.ForeignKey("CopyCentreApp.Category", verbose_name='Категория', on_delete=models.CASCADE)
...
class ProductFeatures(models.Model):
    ...
    product = models.ForeignKey("CopyCentreApp.Product", verbose_name='Товар', on_delete=models.CASCADE)
